...
bindsym Print exec "scrot ~/screenshot/%Y-%m-%d-%T-screenshot.png"
...
bar {
		font pango:Noto sSans Regular 10, FontAwesome 10
...
# you can add different bars for multidisplay setups on each display: # set output HDMI-0 to the display you want the bar, --transparency can be set.
...
exec_always feh --bg-scale ~/Pictures/back.png
