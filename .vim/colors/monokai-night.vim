...
let g:colors_name = "monokai-night"
"}}}
...
let s:palette.bg        = {'dark': "#1F1F1F",  'light': "#FAFAFA",  'mirage': "#1F1F1F"}
...
let s:palette.panel     = {'dark': "#1F1F1F",  'light': "#FFFFFF",  'mirage': "#1F1F1F"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#3D4751"}
let s:palette.line      = {'dark': "#1F1F1F",  'light': "#F3F3F3",  'mirage': "#1F1F1F"}
